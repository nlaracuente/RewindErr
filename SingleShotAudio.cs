...
public class SingleShotAudio : MonoBehaviour
{
    ...
    public void PlaySoundAt(AudioClip clip, Vector3 position, float volume, float pitch = 1f)
    {
    ...
    public void Play2DSound(AudioClip clip, float volume, float pitch = 1f, bool loops = false)
    {
        PlaySound(clip, volume, pitch, loops);
    }
    ...
    void PlaySound(AudioClip clip, float volume = 1f, float pitch = 1f, bool loops = false)
    {
        if (clip == null)
        {
            Destroy(gameObject);
